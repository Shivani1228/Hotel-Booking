//prebuild ui pr gye  https://prebuiltui.com/ on google
...
const Navbar = () => {
  ...
  //Track karta hai ki page scroll hua ya nahi.
  //false matlab scrool ne hai page
  //const [isMenuOpen, setIsMenuOpen] = React.useState(false);
  // Mobile menu open hai ya close.
  //false
  //Matlab mobile menu hidden hai.
  ...
  // Component render hone ke baad chalega.
  useEffect(() => {
